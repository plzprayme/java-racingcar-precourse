...
import domain.validate.IsNumeric;
import domain.validate.IsOnlyComma;
import domain.validate.Validation;
...
public class InputManager {
    ...
    public String inputCarNames() {
        Validator validator = new Validator(new IsOnlyComma());
        String carNames = "";
        System.out.println("경주할 자동차 이름을 입력하세요. (이름은 쉼표(,) 기준으로 구분)");

        if (validator.validation(scanner.next())) {
